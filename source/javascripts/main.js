...
$(document).ready(function(){
	...
	function showhidefilters() {
		...
		if (windowwidth < 700) {
			$('.withfilter .column-first form').hide();
			if ($('.withfilter h3 > button').length === 0) {
				$('.withfilter .column-first h3').append(' <button>Show</button>').on('click', function(){
					$('.withfilter .column-first form').toggle('slow', function(){
			...
			$('.withfilter .column-first form').show();
		}
	}
  ...
  "noOfChildren":99
	...
	$.treevue(root.children, "df").appendTo('#thetestsTreeDiv');
