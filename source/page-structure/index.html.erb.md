...
* **Keyboard users** can browse pages and their sections more efficiently. Otherwise, users need to use multiple strokes of the tab key to navigate through all links in each section.
